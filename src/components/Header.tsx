    ...
    >
      <nav className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3 group">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#a78bfa] to-[#7c3aed] flex items-center justify-center text-white font-bold text-sm group-hover:scale-110 transition-transform duration-300">
            C
          </div>
            ...
            <Link
              ...
              className={`px-4 py-2 text-sm rounded-lg transition-all duration-300 ${
                link.label === "Get Started"
                  ? "bg-[#a78bfa] text-[#09090b] font-medium hover:bg-[#c4b5fd] ml-2"
              ...
              {navLinks.map((link) => (
                <Link
                  ...
                  className={`px-4 py-3 text-sm rounded-lg transition-all duration-300 ${
                    link.label === "Get Started"
                      ? "bg-[#a78bfa] text-[#09090b] font-medium text-center mt-2"
                      : "text-[#a1a1aa] hover:text-white hover:bg-white/5"
                  }`}
                >
                  {link.label}
