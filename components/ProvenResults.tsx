        ...
        */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="flex flex-col items-center justify-center text-center px-6 py-8 relative
            ...
            <div className="mb-1">
              <span className="text-[14px] text-ias-brown-muted line-through">$2,000–$5,000/mo</span>
            </div>
            <p className="text-[34px] font-extrabold text-white leading-tight">
              $199–$799<span className="text-[16px] font-bold">/mo</span>
            </p>
            <p className="text-[13px] text-ias-brown-muted mt-2">vs Traditional Agencies</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center text-center px-6 py-8 relative
            ...
            <p className="text-[13px] font-semibold text-ias-brown-muted uppercase tracking-widest mb-1">Up to</p>
            <p className="text-[42px] font-extrabold text-white leading-none">144</p>
            <p className="text-[13px] text-ias-brown-muted mt-2">SEO Blogs Published Per Year by AI trained on your business</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center text-center px-6 py-8 relative
            ...
            <p className="text-[13px] text-ias-brown-muted mt-2">Support, Always On, Always Available</p>
          </div>

          {/* STAT 4: 90-Day Guarantee */}
          <div className="flex flex-col items-center justify-center text-center px-6 py-8">
            <p className="text-[42px] font-extrabold text-white leading-none">90-Day</p>
            <p className="text-[13px] text-ias-brown-muted mt-2 flex items-center justify-center gap-1.5">
              Ranking Guarantee
