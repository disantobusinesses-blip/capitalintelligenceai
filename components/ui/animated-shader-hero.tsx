...
// Blue/Cyan themed shader (adapted from original warm shader)
...
const AnimatedShaderHero: React.FC<ShaderHeroProps> = ({ children, className = '' }) => {
