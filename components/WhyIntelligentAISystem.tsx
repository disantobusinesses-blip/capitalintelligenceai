...
const POINTS = [
  ...
  },
  {
    ...
    link: { label: 'See how it works', href: '/services#b2b' },
  },
  {
    icon: Layers,
            ...
            return (
              ...
              >
                <div className="w-11 h-11 bg-white rounded-[6px] flex items-center justify-center mb-5">
                  <Icon className="w-5 h-5 text-ias-brown-mid" strokeWidth={1.5} />
                </div>
                ...
                {point.link && (
                  <Link
                    ...
                    className="mt-4 text-sm font-semibold text-ias-brown-dark hover:text-ias-brown-mid underline underline-offset-2"
                  >
                    {point.link.label}
                  </Link>
                )}
