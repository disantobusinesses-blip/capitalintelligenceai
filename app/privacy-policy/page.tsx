...
export default function PrivacyPolicy() {
  return (
    <main className="min-h-screen bg-white">
      {/* Header */}
      <div className="bg-luxury-off-white border-b border-luxury-silver-light">
        <div className="max-w-4xl mx-auto px-6 py-8">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-luxury-charcoal hover:text-luxury-silver-dark smooth-transition mb-6"
          >
            <ArrowLeft className="w-5 h-5" />
            Back to Home
          </Link>
          <h1 className="text-4xl md:text-5xl font-bold text-luxury-charcoal">
            Privacy Policy
          </h1>
          <p className="text-luxury-silver-dark mt-2">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 space-y-8">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 text-luxury-charcoal space-y-2 mb-4">
          ...
          <ul className="list-disc pl-6 text-luxury-charcoal space-y-2">
        ...
        <section>
          ...
          <div className="bg-luxury-off-white rounded-lg p-6 border border-luxury-silver-light">
            <p className="text-luxury-charcoal font-semibold mb-2">Capital Intelligence Group</p>
            <p className="text-luxury-charcoal">Trading as: Intelligent Systems</p>
            <p className="text-luxury-charcoal">ABN: 38 693 023 371</p>
          </div>
        </section>
      </div>
    </main>
