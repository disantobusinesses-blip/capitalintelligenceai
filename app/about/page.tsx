    ...
    <div className="min-h-[100dvh] pb-24">
      ...
      <section className="py-24 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <p className="text-xl text-tech-platinum leading-relaxed mb-4">
            Capital Intelligence Group
          </p>
          <p className="text-lg text-tech-platinum max-w-2xl mx-auto leading-relaxed">
      ...
      <section className="py-16 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-tech-white mb-6">Who We Are</h2>
              <div className="space-y-4 text-tech-platinum leading-relaxed">
                <p>
              ...
              <p className="text-sm text-tech-platinum mt-6">
                ABN: 38 693 023 371
              </p>
            </div>
            <div className="bg-tech-gray border border-tech-baby-blue/20 rounded-2xl p-8 text-center">
              <div className="w-20 h-20 bg-gradient-blue rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-glow">
      ...
      <section className="py-16 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-tech-white text-center mb-12">What Drives Us</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-tech-gray border border-tech-baby-blue/20 rounded-xl p-6 smooth-transition hover:border-tech-baby-blue hover:shadow-glow-sm"
                >
                  ...
                  <h3 className="text-lg font-bold text-tech-white mb-2">{value.title}</h3>
                  <p className="text-sm text-tech-platinum leading-relaxed">{value.description}</p>
                </div>
              )
            })}
          </div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-tech-white text-center mb-12">What We Offer</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-tech-gray border border-tech-baby-blue/20 rounded-2xl p-8 smooth-transition hover:border-tech-baby-blue hover:shadow-glow-sm">
              <h3 className="text-xl font-bold text-tech-white mb-4">Professional Websites</h3>
              <ul className="space-y-2 text-tech-platinum text-sm">
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 bg-tech-baby-blue rounded-full mt-1.5 flex-shrink-0" />
                  Landing pages from $599 AUD
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 bg-tech-baby-blue rounded-full mt-1.5 flex-shrink-0" />
                  Full multi-page websites from $1,999 AUD
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 bg-tech-baby-blue rounded-full mt-1.5 flex-shrink-0" />
            ...
            <div className="bg-tech-gray border border-tech-baby-blue/20 rounded-2xl p-8 smooth-transition hover:border-tech-baby-blue hover:shadow-glow-sm">
              <h3 className="text-xl font-bold text-tech-white mb-4">AI Integrations</h3>
              <ul className="space-y-2 text-tech-platinum text-sm">
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 bg-tech-baby-blue rounded-full mt-1.5 flex-shrink-0" />
            ...
            <div className="bg-tech-gray border border-tech-baby-blue/20 rounded-2xl p-8 smooth-transition hover:border-tech-baby-blue hover:shadow-glow-sm">
              <h3 className="text-xl font-bold text-tech-white mb-4">Ongoing Support</h3>
              <ul className="space-y-2 text-tech-platinum text-sm">
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 bg-tech-baby-blue rounded-full mt-1.5 flex-shrink-0" />
      ...
      <section className="py-16 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-tech-white mb-6">Ready to Get Started?</h2>
